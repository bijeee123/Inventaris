    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white shadow-md rounded-xl p-5 flex items-center justify-between hover:shadow-lg transition">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1">{{ $keluarHariIni }}</p>
        ...
        <div class="bg-white shadow-md rounded-xl p-5 flex items-center justify-between hover:shadow-lg transition">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1">{{ $barangKeluar->where('kategori','Makanan Ringan')->count() }}</p>
        ...
        <div class="bg-white shadow-md rounded-xl p-5 flex items-center justify-between hover:shadow-lg transition">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1">{{ $barangKeluar->where('kategori','Makanan Berat')->count() }}</p>
        ...
        <div class="bg-white shadow-md rounded-xl p-5 flex items-center justify-between hover:shadow-lg transition">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1">{{ $barangKeluar->where('kategori','Minuman')->count() }}</p>
                <p class="text-gray-600 text-sm mt-1">Transaksi Masuk</p>
            </div>
            <div class="bg-blue-600 text-white p-3 rounded-lg">
...
<div class="mt-10" x-data="{ tab: 'Makanan Ringan' }">
    <div class="bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
        <h3 class="text-2xl font-bold mb-3 text-gray-600">Riwayat Barang Keluar per Kategori</h3>
        ...
        @foreach($barangKeluar->groupBy('kategori') as $kategori => $items)
            @php
                ...
                @forelse($items as $item)
                    <div class="bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex justify-between items-center border border-gray-200 shadow-sm transition-all duration-200">
                        ...
                        <div class="text-right">
                            <p class="font-bold">
                                <span class="text-blue-600">-{{ $item->jumlah_keluar }} unit</span>
